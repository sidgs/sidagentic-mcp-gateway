import {
  IconButton_default
} from "./chunk-NFSGPGTF.js";
import "./chunk-W6MUH35R.js";
import {
  Paper_default
} from "./chunk-J7ED3NUS.js";
...
import {
  createSvgIcon
} from "./chunk-JO4HGOA5.js";
import {
  capitalize_default
} from "./chunk-2I3UZEXT.js";
import "./chunk-H4CVW7GX.js";
...
var alertClasses = generateUtilityClasses("MuiAlert", ["root", "action", "icon", "message", "filled", "colorSuccess", "colorInfo", "colorWarning", "colorError", "outlined", "standard"]);
...
var useUtilityClasses = (ownerState) => {
  ...
  const slots = {
    root: ["root", `color${capitalize_default(color || severity)}`, `${variant}`],
    icon: ["icon"],
    message: ["message"],
    action: ["action"]
  };
