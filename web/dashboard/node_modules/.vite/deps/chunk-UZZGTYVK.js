...
function FocusTrap(props) {
  ...
  React3.useEffect(() => {
    ...
    const contain = () => {
      ...
      if (contains_default(rootElement, activeEl)) {
        return;
      }
...
var Modal = React5.forwardRef(function Modal2(inProps, ref) {
  ...
  const [BackdropSlot, backdropProps] = useSlot("backdrop", {
    ...
    className: classes == null ? void 0 : classes.backdrop,
    ownerState
  });
  ...
  return (0, import_jsx_runtime4.jsx)(Portal_default, {
    ...
    children: (0, import_jsx_runtime4.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop ? (0, import_jsx_runtime4.jsx)(BackdropSlot, {
        ...backdropProps
...
//# sourceMappingURL=chunk-UZZGTYVK.js.map
