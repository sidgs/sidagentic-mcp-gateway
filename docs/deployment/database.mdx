...
description: "Choose SQLite for local evaluation or PostgreSQL for serious deployments, and configure Mcpjungle with either a full DSN or Postgres-specific environment variables."
---
...
When no database configuration is provided, Mcpjungle automatically creates a SQLite file named `sami-mcp-gateway.db` in the directory where the process is started:
