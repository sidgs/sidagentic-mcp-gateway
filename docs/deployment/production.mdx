...
After the first boot in enterprise mode, run `sami-mcp-gateway init-server` once from your client machine to create the initial admin identity and authenticate your CLI.
