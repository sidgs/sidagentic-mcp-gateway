...
description: "Understand Mcpjungle's two session modes, when persistent connections help, and why stateless should remain the default unless cold-start cost is a real problem."
---
