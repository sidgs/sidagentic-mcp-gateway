---
title: "Mcpgateway Documentation"
...
<p align="center">
  <img src="/images/sami-mcp-gateway-diagram-april-2026.png" alt="sami-mcp-gateway product diagram" />
</p>
...
## Use Cases
Mcpgateway is primarily built for:
...
<Info>
    AI agents can also access the sami-mcp-gateway documentation using MCP - `https://docs.sami-mcp-gateway.com/mcp`.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Self-hosted infrastructure" icon="server">
    Run Mcpgateway locally for yourself or on your own infrastructure for a team. Your MCP traffic, tool access, and operational data stay inside infrastructure you control.
  </Card>
...
<Steps>
  <Step title="Start the server">
    Pull the Docker Compose file and start Mcpgateway with a persistent Postgres database:
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy and operate" icon="cloud" href="/deployment/production">
    Run Mcpgateway in local or enterprise mode with the right database, runtime, and observability setup.
  </Card>
